...
{
	std::string_view ExpressionPrintNoParent::string_from(ast::Expression& e)
	{
		string_stack.clear();
		e.accept( *this );
	...
	void ExpressionPrintNoParent::visit(ast::Identifier& e)
	{
		string_stack.emplace_back( e.value() );
	}

	void ExpressionPrintNoParent::visit(ast::CppVariable& e)
	{
		string_stack.emplace_back( e.value() );
	}

	void ExpressionPrintNoParent::visit(ast::LogicalVariable& e)
	{
		string_stack.emplace_back( e.value() );
	}

	void ExpressionPrintNoParent::visit(ast::Literal& e)
	{
		string_stack.emplace_back( e.value() );
	}

	void ExpressionPrintNoParent::visit(ast::PrefixExpression& e)
	{
		e.child()->accept(*this);
	...
	void ExpressionPrintNoParent::visit(ast::PostfixExpression& e)
	{
		e.child()->accept(*this);
		assert( string_stack.size() >= 1 );
	...
	void ExpressionPrintNoParent::visit(ast::InfixExpression& e)
	{
	...
	void ExpressionPrintNoParent::visit(ast::TernaryExpression& e)
	{
	...
	void ExpressionPrintNoParent::visit(ast::BuiltinConstraint& e)
	{
	...
	void ExpressionPrintNoParent::visit(ast::ChrConstraint& e)
	{
		std::size_t args = e.children().size();
	...
	void ExpressionPrintNoParent::visit(ast::ChrCount& e)
	{
